...
import { BookOpen, TrendingUp, Award, Calendar, ChevronRight, BarChart3 } from 'lucide-react';
...
export const AcademicProgress: React.FC<AcademicProgressProps> = ({ user, courses }) => {
  ...
  const averageProgress = currentSemesterCourses.length > 0 
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-green-600">{completedCredits}/{totalCredits}</p>
