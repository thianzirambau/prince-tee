...
import { Calendar, Clock, Users, MapPin, Plus, Filter, CheckCircle, XCircle, AlertCircle } from 'lucide-react';
...
export const VenueBooking: React.FC<VenueBookingProps> = ({ venues, bookings, onBookVenue, onCancelBooking }) => {
  ...
  const getVenueTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'conference-hall': return 'bg-purple-100 text-purple-800';
